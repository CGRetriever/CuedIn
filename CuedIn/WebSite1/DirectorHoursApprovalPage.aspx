<%@ Page Title="" Language="C#" MasterPageFile="~/Director.master" AutoEventWireup="true" CodeFile="DirectorHoursApprovalPage.aspx.cs" Inherits="DirectorHoursApprovalPage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <li><a href="DirectorStudentActDec.aspx">Student Application Request</a></li>
                ...
                <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-striped  table-dark"  AutoGenerateColumns="False" DataKeyNames="LogID"  CellPadding="1" BackColor="#102B40" ForeColor="White" OnDataBinding="btnCheckGridView_Click">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Image">
                            <ItemTemplate>
                                <asp:Image ID="studentImage" runat="server" style="max-width:7em;max-height:7em; margin-left:2em;" ImageUrl='<%#Bind("StudentImage")%>'  CssClass="img-fluid" BackColor="White" />
                            </ItemTemplate>
