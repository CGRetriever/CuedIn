<%@ Page Title="" Language="C#" MasterPageFile="~/OA.master" AutoEventWireup="true" CodeFile="OAScholarshipBoard.aspx.cs" Inherits="OAScholarshipBoard" %>
        ...
        <link rel="stylesheet" href="css/style.css">
         ...
         <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.2/css/all.css" integrity="sha384-fnmOCqbTlWIlj8LyTjo7mOUStjsKC4pOpQbqyi7RrhN7udi9RwhKkMHpvLbHG9Sr" crossorigin="anonymous">
            ...
            <div class='container'>     <!-- Main container div -->
                ...
                <div class='row'>       <!-- Row start div -->
                <div class='col-12 '>   <!-- Recent Scholarship Div -->
                    <p>More Scholarships</p>
                </div>                  <!-- Close Recent Scholarship text div -->
