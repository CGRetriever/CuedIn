...
<!--- END Breadcrumb --->
        ...
        <div class="form-group">
            <div class="col-md-8 container-fluid text-center">
                ...
                <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-striped table-responsive table-dark" Style="border-collapse: collapse; width:auto;" AutoGenerateColumns="False" DataKeyNames="LogID"  CellPadding="1" BackColor="#102B40" ForeColor="White" OnRowUpdating="btnCheckGridView_Click" OnDataBinding="btnCheckGridView_Click">
                    <Columns>
