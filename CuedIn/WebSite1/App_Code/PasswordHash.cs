...
public class PasswordHash
{
    ...
    //method to return the salt value. Needed this to insert into the salt for the adventure works wh
    public static String returnSalt(String correctHash)
    {
        char[] delimiter = { ':' };
        var split = correctHash.Split(delimiter);
        String mySalt = split[SaltIndex];
        return mySalt;
