<%@ Page Title="" Language="C#" MasterPageFile="~/Counselor.master" AutoEventWireup="true" CodeFile="CounselorLandingPage.aspx.cs" Inherits="CounselorLandingPage" %>
...
<script type='text/javascript' src='https://us-east-1.online.tableau.com/javascripts/api/viz_v1.js'></script><div class='tableauPlaceholder' style='width: 100%; height: 252px;'><object class='tableauViz' width='100%' height='252' style='display:none;'><param name='host_url' value='https%3A%2F%2Fus-east-1.online.tableau.com%2F' /> <param name='embed_code_version' value='3' /> <param name='site_root' value='&#47;t&#47;commup' /><param name='name' value='LandingPageDashPhoneLouisaCounty&#47;Dashboard1' /><param name='tabs' value='no' /><param name='toolbar' value='yes' /><param name='showAppBanner' value='false' /><param name='filter' value='iframeSizedToWindow=true' /></object></div>      </div>
        ...
        <asp:LinkButton ID="OppPageLink" runat="server" CssClass="btn" PostBackUrl="~/CounselorOpportunityActDec.aspx"><i class="fas fa-arrow-circle-right fa-2x"></i></asp:LinkButton>
            </h3>
        <div class="row">
            ...
            <!-- Team member -->
          <div class="col-md-4 col-xs-12 col-sm-12" id="card1" runat="server">
                        ...
                        <div class="backside">
                            <div class="card">
                                <div class="card-body text-center mt-4">
                                    <asp:Label ID="CompanyNamelbl2" runat="server" Text="Sunlimetech" CssClass="card-title" Style="color: #102B3F; font-family: 'Poppins', sans-serif;  padding-left: 20px; padding-right: 20px;"></asp:Label>
            ...
            <!-- ./Team member -->
            <!-- Team member -->
          <div class="col-md-4 col-xs-12 col-sm-12" id="card2" runat="server">
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                        ...
                        <div class="backside">
                            <div class="card">
                                <div class="card-body text-center mt-4">
                                    <asp:Label ID="CompanyNamelbl4" runat="server" Text="Sunlimetech" CssClass="card-title" Style="color: #102B3F; font-family: 'Poppins', sans-serif;  padding-left: 20px; padding-right: 20px;"></asp:Label>
                                    <div class="form-group text-left">
            ...
            <!-- ./Team member -->
             <!-- Team member -->
        <div class="col-md-4 col-xs-12 col-sm-12" id="card3" runat="server">
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
        ...
        <h3 class="">Student Applications Pending Approval
            <asp:LinkButton ID="StudentPageLink" runat="server" CssClass="btn" PostBackUrl="~/CounselorStudentActDec.aspx"><i class="fas fa-arrow-circle-right fa-2x"></i></asp:LinkButton>
        </h3>
        <div class="row">
            ...
            <!-- Team member -->
           <div class="col-md-4 col-xs-12 col-sm-12" id="StudentCard1" runat="server">
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                        ...
                        <div class="backside">
                            <div class="card">
                                <div class="card-body text-center mt-4">
                                    <asp:Label ID="BackStudentName" runat="server" Text="Text" CssClass="card-title" Style="color: #102B3F; font-family: 'Poppins', sans-serif; padding-left: 20px; padding-right: 20px; "></asp:Label>
                                    <div class="form-group text-left">
            ...
            <!-- ./Team member -->
            <!-- Team member -->
           <div class="col-md-4 col-xs-12 col-sm-12" id="StudentCard2" runat="server">
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                        ...
                        <div class="backside">
                            <div class="card">
                                <div class="card-body text-center mt-4">
                                    <asp:Label ID="BackStudentName2" runat="server" Text="Text" CssClass="card-title" Style="color: #102B3F; font-family: 'Poppins', sans-serif; padding-left: 20px; padding-right: 20px;"></asp:Label>
                                    <div class="form-group text-left">
            ...
            <!-- ./Team member -->
            <!-- Team member -->
            <div class="col-md-4 col-xs-12 col-sm-12" id="StudentCard3" runat="server">
                <div class="image-flip"ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                        ...
                        <div class="backside">
                            <div class="card">
                                <div class="card-body text-center mt-4">
                                    <asp:Label ID="BackStudentName3" runat="server" Text="Text" CssClass="card-title" Style="color: #102B3F; font-family: 'Poppins', sans-serif; padding-left: 20px; padding-right: 20px;"></asp:Label>
                                    <div class="form-group text-left">
