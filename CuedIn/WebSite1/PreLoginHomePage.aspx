...
<nav class="navbar fixed-top navbar-expand-md navbar-light bg-light">
    ...
    <div class="w-100 d-flex flex-nowrap">
       <%-- <div class ="links" style="padding-top:350px; padding-right:50px; position:fixed;">
        <br />
        <br />
        <p><a id="phoneDownBtn" class="scroll-down ct-btn-scroll ct-js-btn-scroll phone" href="#phone"><img alt="Arrow Down Icon" src="https://www.solodev.com/assets/anchor/arrow-down.png"/></a></p>
        <p><a id="smallDesktopDownBtn" class="scroll-down ct-btn-scroll ct-js-btn-scroll smallDesktop" href="#smallDesktop"><img style="position:fixed;"  alt="Arrow Down Icon" src="https://www.solodev.com/assets/anchor/arrow-down.png"/></a></p>
        <p><a id="bigDesktopDownBtn" class=" scroll-down ct-btn-scroll ct-js-btn-scroll bigDesktop" href="#bigDesktop"><img style="position:fixed;"  alt="Arrow Down Icon" src="https://www.solodev.com/assets/anchor/arrow-down.png"/></a></p>
        </div>--%>
...
<script type='text/javascript' src='https://us-east-1.online.tableau.com/javascripts/api/viz_v1.js'></script><div class='tableauPlaceholder' style='width: 100%; height: 927px;'><object class='tableauViz' width='100%' height='927' style='display:none;'><param name='host_url' value='https%3A%2F%2Fus-east-1.online.tableau.com%2F' /> <param name='embed_code_version' value='3' /> <param name='site_root' value='&#47;t&#47;commup' /><param name='name' value='OutsiderDash_LargeDesktop&#47;NewComerDash' /><param name='tabs' value='no' /><param name='toolbar' value='yes' /><param name='showAppBanner' value='false' /><param name='filter' value='iframeSizedToWindow=true' /></object></div> </div>
    ...
    $('.scroll-down').click (function() {
      $('html, body').animate({scrollTop: $('.bigDesktop').offset().top }, 'slow');
      return false;
    });
  });
</script>
